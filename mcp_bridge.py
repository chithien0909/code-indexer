#!/usr/bin/env python3
"""
MCP stdio bridge that provides a working MCP protocol implementation.
This bridges stdio MCP requests to the working daemon HTTP API.
"""
    ...
    def start_daemon(self) -> bool:
        ...
        try:
            ...
            cmd = [
                ...
                "code-indexer", "daemon", "--port", str(self.daemon_port), "--log-level", "info"
            ]
